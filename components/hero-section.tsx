...
export function HeroSection() {
  return (
    ...
    <div className="relative bg-transparent bg-black/40">
      <Image className="absolute h-full w-full top-0 -z-10 b" src="https://imgs.search.brave.com/7JPr6LCD--6fj92MW_RE1pc9OvX1rBWqMhRbhawzmaM/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9pbWcu/ZnJlZXBpay5jb20v/ZnJlZS1waG90by9h/aXJwb3J0LXRlcm1p/bmFsXzE0MTctMTQ1/Ni5qcGc_c2VtdD1h/aXNfaHlicmlk" height={200} width={300} alt="hero"/>
